...
const ui: Record<string, React.CSSProperties> = {
  ...
  predGrid: { display: "grid", gridTemplateColumns:"repeat(auto-fit,minmax(90px,1fr))",gap: "14px", marginTop: "10px" },
  predBox: { background: "#04151f", padding: "12px", borderRadius: "10px", width: "100px", textAlign: "center" }
};
